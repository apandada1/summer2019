...
When we calculate the change in entropy, we need to take into account the effective temperatures  ${T^*_{high}}$ and ${T^*_{low}}$ of the heat baths, and that is why, the second law of thermodynamics would not be violated. When we use this special stochastic force, the system is really coupled to two heat baths of different temperatures, and we should not compare its efficiency to the ``formula" of standard Carnot efficiency, with some intermediate temperature $T_{high}$ and $T_{low}$.
