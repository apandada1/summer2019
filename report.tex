...
\begin{equation}\begin{aligned}\label{eq:x_average} \text{Thus, }
...
Let us define ``rotating coordinates", \begin{equation}\begin{array} { l } { X _ { 1 } = X \cos \left( \omega _ { 0 } t \right) - P \sin ( \omega_0  t ) } \\ { X _ { 2 } = X \sin ( \omega_0  t ) + P \cos ( \omega_0  t ) } \end{array}\end{equation}
 ...
 \\ & \approx \frac{kT}{\hbar\omega_0}\left[\cosh(2r) - \frac{\sinh(2r)}{2}\right] \left(\text{in the limit of low damping, } \frac{\gamma}{\omega_0} \ll 1\right)
 \end{aligned}$
\section{Conclusion}
