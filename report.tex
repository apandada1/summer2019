...
I created a C program \cite{link_to_c_code} to numerically solve (\ref{eq:Langevin}) and (\ref{eq: stochastic}) numerically with Runge-Kutta method \cite{wikipedia_runge_kutta} of order 4. The delta function force is simulated with a random force of very high magnitude (high compared to the spring force).
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.3\linewidth]{graphs/P-V_Otto_cycle.png}
